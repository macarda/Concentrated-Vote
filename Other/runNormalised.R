...
#Constituencies normalised to 100, Independent Candidates Separated Out
#2017
...
votes2017=(votes2017/rowSums(votes2017))*100
...
write.csv(ans.uk, file = "Output/ans2017ind.csv",row.names=FALSE)
...
votes2015=(votes2015/rowSums(votes2015))*100
...
ans.uk=rbind(ans.ni, ans.gb, fill=TRUE)
ans.uk[is.na(ans.uk)] <- 0
write.csv(ans.uk, file = "Output/ans2015ind.csv",row.names=FALSE)
...
votes2010=(votes2010/rowSums(votes2010))*100
...
ans.uk=rbind(ans.ni, ans.gb, fill=TRUE)
ans.uk[is.na(ans.uk)] <- 0
write.csv(ans.uk, file = "Output/ans2010ind.csv",row.names=FALSE)
...
votes2005=(votes2005/rowSums(votes2005))*100
...
ans.uk=rbind(ans.ni, ans.gb, fill=TRUE)
ans.uk[is.na(ans.uk)] <- 0
write.csv(ans.uk, file = "Output/ans2005ind.csv",row.names=FALSE)
...
votes2001=(votes2001/rowSums(votes2001))*100
...
ans.uk=rbind(ans.ni, ans.gb, fill=TRUE)
ans.uk[is.na(ans.uk)] <- 0
write.csv(ans.uk, file = "Output/ans2001ind.csv",row.names=FALSE)
...
votes1997=(votes1997/rowSums(votes1997))*100
...
ans.uk=rbind(ans.ni, ans.gb, fill=TRUE)
ans.uk[is.na(ans.uk)] <- 0
write.csv(ans.uk, file = "Output/ans1997ind.csv",row.names=FALSE)
...
votes1992=(votes1992/rowSums(votes1992))*100
...
ans.uk=rbind(ans.ni, ans.gb, fill=TRUE)
ans.uk[is.na(ans.uk)] <- 0
write.csv(ans.uk, file = "Output/ans1992ind.csv",row.names=FALSE)
...
votes1987=(votes1987/rowSums(votes1987))*100
...
ans.uk=rbind(ans.ni, ans.gb, fill=TRUE)
ans.uk[is.na(ans.uk)] <- 0
write.csv(ans.uk, file = "Output/ans1987ind.csv",row.names=FALSE)
...
votes1983=(votes1983/rowSums(votes1983))*100
...
ans.uk=rbind(ans.ni, ans.gb, fill=TRUE)
ans.uk[is.na(ans.uk)] <- 0
write.csv(ans.uk, file = "Output/ans1983ind.csv",row.names=FALSE)
...
votes1979=(votes1979/rowSums(votes1979))*100
...
ans.uk=rbind(ans.ni, ans.gb, fill=TRUE)
ans.uk[is.na(ans.uk)] <- 0
write.csv(ans.uk, file = "Output/ans1979ind.csv",row.names=FALSE)